...
This section documents the complete workflow for validating a real OGC API implementation.
...
| Specification | Core Class | Optional Classes |
|--------------|------------|------------------|
| OGC API - Features Part 1 | `core`, `oas30` | `html`, `geojson`, `gmlsf0`, `gmlsf2` |
| OGC API - Features Part 2 | `crs` | - |
| OGC API - Common Part 1 | `core`, `landing-page` | `oas30`, `html`, `json` |
| OGC API - Tiles Part 1 | `core`, `tileset` | `dataset-tilesets`, `geodata-tilesets` |
| OGC API - Processes Part 1 | `core` | `ogc-process-description`, `job-list`, `dismiss` |
| OGC API - EDR Part 1 | `core` | `collections`, `queries` |
